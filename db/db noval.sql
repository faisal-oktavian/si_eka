...
CREATE TABLE paket_belanja_log (
    ...
    transaction_id CHAR(36) NOT NULL
        COMMENT '1 kali tombol simpan = 1 transaction_id',
    ...
    INDEX idx_paket (modul, paket_id),
...
ALTER TABLE `paket_belanja_log`
	CHANGE COLUMN `entity_type` `entity_type` ENUM('PAKET','DETAIL','SUB_DETAIL', 'PAKET_PAPBD', 'DETAIL_PAPBD', 'SUB_DETAIL_PAPBD') NOT NULL COLLATE 'utf8mb4_unicode_ci' AFTER `modul`;
ALTER TABLE `paket_belanja_log`
	CHANGE COLUMN `entity_type` `entity_type` ENUM('PAKET','DETAIL','SUB_DETAIL','SUB_SUB_DETAIL','SUB_SUB_DETAIL_SPESIFIKASI','PAKET_PAPBD','DETAIL_PAPBD','SUB_DETAIL_PAPBD') NOT NULL COLLATE 'utf8mb4_unicode_ci' AFTER `modul`;
ALTER TABLE `paket_belanja_log`
	CHANGE COLUMN `changed_by` `changed_by` VARCHAR(50) NULL DEFAULT NULL AFTER `note`;
...
CREATE TABLE `pad_kode_rekening` (
	...
	INDEX `kode_rekening` (`kode_rekening`) USING BTREE,
