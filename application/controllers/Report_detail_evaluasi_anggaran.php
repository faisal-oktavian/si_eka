...
// echo "<pre>"; print_r($detail_data);die;
    ...
    */
    ...
    private function query_get_sisa_uang($the_data) {
        ...
        $nilai_realisasi = 0;
        if ($npd->num_rows() > 0) {
            $nilai_realisasi = (float) $npd->row()->total;
        }

        return $nilai_realisasi;
    }

    private function query_get_total_realisasi($the_data) {
        $total_realisasi = 0;
