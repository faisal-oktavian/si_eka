...
class Report_sisa_anggaran extends CI_Controller {
	public function __construct() {
        parent::__construct();

        $this->load->helper('az_auth');
        az_check_auth('role_report_sisa_realisasi_anggaran');
        $this->controller = 'report_sisa_anggaran';
	...
	public function index(){
		...
		$data_header['title'] = 'Laporan Sisa Anggaran';
