<form class="form-horizontal purchase-contract">
	...
	<div class="form-group">
		<label class="control-label col-sm-2">Nomor Kontrak</label>
		<div class="col-md-4 col-sm-6">
			<input type="text" class="form-control" name="contract_code" id="contract_code" placeholder="Nomor Kontrak">
		</div>
	</div>
	<div class="form-group">
