<form class="form-horizontal" id="form_add">
	<input type="hidden" id="idnpd_panjer" name="idnpd_panjer" class="x-hidden" value="<?php echo $id;?>">
	<input type="hidden" id="idnpd_panjer_detail" name="idnpd_panjer_detail" class="x-hidden">
	...
	<div class="form-group description">
		...
		<div class="col-md-8">
			<textarea class="form-control" name="npd_detail_description" id="npd_detail_description" rows="5"></textarea>
		</div>
	</div>
</form>