...
<div class="container-table">
  <div class="table-responsive">
    <table id="selectedColumn" class="table table-hover table-bordered table-sm table-condensed" cellspacing="0" width="100%" data-ordering="false">
      <thead>
        <tr>
          <th class="th-sm rak" colspan="9">RENCANA ANGGARAN KAS <br> SATUAN KERJA PERANGKAT DAERAH</th>
        </tr>
        <tr>
          <th class="th-sm provinsi" colspan="9">PROVINSI JAWA TIMUR <br> TAHUN ANGGARAN <?php echo $tahun_anggaran; ?></th>
        </tr>
      </thead>
      <tbody>
          <?php
                    ...
                    foreach ($k_value['sub_kegiatan'] as $sk_key => $sk_value) { // loopping sub kegiatan
                      ...
                      ?>
                        <tr>
                          ...
                          <td colspan="7"><?php echo $value['nama_urusan']; ?></td>
                        </tr>
                        <tr>
                          <td>Bidang Urusan</td>
                          <td class="titik-dua">:</td>
                          <td colspan="7"><?php echo $bu_value['nama_bidang_urusan']; ?></td>
                        </tr>
                        <tr>
                          <td>Program</td>
                          <td class="titik-dua">:</td>
                          <td colspan="7"><?php echo $p_value['nama_program']; ?></td>
                        </tr>
                        <tr>
                          <td>Kegiatan</td>
                          <td class="titik-dua">:</td>
                          <td colspan="7"><?php echo $k_value['nama_kegiatan']; ?></td>
                        </tr>
                        <tr>
                          <td>Sub Kegiatan</td>
                          <td class="titik-dua">:</td>
                          <td colspan="7"><?php echo $sk_value['nama_sub_kegiatan']; ?></td>
                        </tr>
                        <tr>
                          <td>Paket Belanja</td>
                          <td class="titik-dua">:</td>
                          <td colspan="7"><?php echo $pb_value['nama_paket_belanja']; ?></td>
                        </tr>
                        <tr>
                          <td>Jumlah</td>
                          <td class="titik-dua">:</td>
                        ...
                        <!-- separator -->
                        <tr><td colspan="9" style="padding-top: 10px;"></td></tr>
