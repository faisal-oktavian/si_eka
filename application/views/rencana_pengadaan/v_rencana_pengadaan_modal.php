<form class="form-horizontal" id="form_add">
    ...
    <div class="detail-paket-belanja hide">
        <div class="form-group">
            ...
            <div class="col-md-8">
                <input type="" class="form-control" name="idpaket_belanja" id="idpaket_belanja">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <input type="" class="form-control" name="idpaket_belanja_detail_sub" id="idpaket_belanja_detail_sub">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <input type="" class="form-control" name="harga_satuan" id="harga_satuan">
                <div class="input-group">
                    <input type="text" class="form-control format-number txt-right volume-paket-belanja" id="volume_paket_belanja" name="volume_paket_belanja" readonly/>
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                ...
                <input type="" class="form-control" name="purchase_plan_detail_total" id="purchase_plan_detail_total">
            </div>
        </div>
    </div>
</form>