<script>
	...
	jQuery('#verification_date_created').datetimepicker({
		format: 'DD-MM-YYYY HH:mm:ss'
	});

	jQuery('body').on('click', '#btn_add_realisasi_anggaran', function() {
	...
	jQuery("#search_realisasi_anggaran").select2({
		placeholder: "~ Cari Realisasi Anggaran ~",
		allowClear: true,
		minimumInputLength: 0,
		ajax: { 
		    url: app_url + 'verifikasi_dokumen/search_realisasi_anggaran',
		    dataType: "json",
		    delay: 250,
	...
	jQuery('body').on('change', '#search_realisasi_anggaran', function() {
