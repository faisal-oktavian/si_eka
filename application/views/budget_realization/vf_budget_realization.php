<form class="form-horizontal">
	...
	<div class="form-group">
		<label class="control-label col-sm-2">Nomor Realisasi</label>
		<div class="col-md-4 col-sm-6">
			<input type="text" class="form-control" name="vf_realization_code" id="vf_realization_code" placeholder="Nomor Realisasi Anggaran">
		</div>
	</div>
	<div class="form-group">
