<form class="form-horizontal">
	<div class="form-group">
		...
		<div class="col-md-4 col-sm-6">
			<input type="text" class="form-control" name="vf_no_rekening_subkegiatan" id="vf_no_rekening_subkegiatan" placeholder="No. Rekening">
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-md-4 col-sm-6">
			<input type="text" class="form-control" name="vf_nama_subkegiatan" id="vf_nama_subkegiatan" placeholder="Nama Sub Kegiatan">
		</div>
	</div>
	<div class="form-group">
